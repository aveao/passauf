...
pub static DATA_GROUPS: phf::Map<&'static str, &'static DataGroup> = phf_map! {
    ...
    "EF.DG2" => &DataGroup{tag: 0x75, dg_num: 2, file_id: 0x0102, description: "Encoded Face", pace_only: false, eac_only: false, in_lds1: true, parser: dg_parsers::ef_dg2::parser, is_binary: true},
